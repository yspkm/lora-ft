...
def train_model(model_name, base_model, data_path, output_dir):
    ...
    wandb_run_name = f"{model_name}_{TRAINING_CONFIG['adapter_name']}_{dataset_type}_{CUR_DATETIME}"
    # fmt: off
    command = [
        ...
        "--micro_batch_size", str(8 if "9b" in model_name else TRAINING_CONFIG["micro_batch_size"]),
